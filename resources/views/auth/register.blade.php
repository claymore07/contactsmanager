                ...
                <div class="panel-body text-center">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 col-md-push-6 control-label">نام و نام خانوادگی : </label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 col-md-push-6 control-label">تایید کلمه عبور : </label>
