...
<body >
  <div class="container-fluid" id="wrapper ">
    ...
    <div class="row">
      <div class="col-sm-2 col-sm-push-10 hidden-xs" style="direction: rtl">
        <div id="tree"></div>
      </div>

      <div class="col-sm-10 col-sm-pull-2 col-xs-12" id="main" style="border-right: solid gray 1px">
  ...
  <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="text-align: right; direction: rtl">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('unisharp.lfm.upload') }}" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data'>
            <div class="form-group" id="attachment" style="text-align: right; direction: rtl">
              <label for='upload' class='control-label'>{{ trans('laravel-filemanager::lfm.message-choose') }}</label>
              <div class="controls">
                <div class="input-group" style="width: 100%; direction: ltr">
                  <input type="file" id="upload" name="upload[]" multiple  data-buttonText="انتخاب تصویر" data-buttonBefore="true" data-buttonName="btn-primary" class="form-control filestyle">
                </div>
              </div>
            </div>
